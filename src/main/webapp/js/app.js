...
app.factory('oauth2Provider', function ($modal) {
    var oauth2Provider = {
        CLIENT_ID: '452065867342-93qlftq8a65dcmp48hrsuo7un6btddvf.apps.googleusercontent.com',
        SCOPES: 'https://www.googleapis.com/auth/userinfo.email profile https://www.googleapis.com/auth/plus.login',
        signedIn: false
    };
